...
//            int rootint = asInt(root.symbol);
//            int newnodesymbol = asInt(s);
//            if(newnodesymbol < rootint){
//                if (root.left == null) {
//                    root.left = newNode;
//                }
//                else {
...
//            }
    ...
    public void rInsert (String s, Node node){
            Node newnode = new Node(s);
            int nodeSymbol = asInt(node.symbol);
            int newnodesymbol = asInt(s);
            if(newnodesymbol < nodeSymbol){
                if (node.left == null) {
                    node.left = newnode;
                }
                else {
